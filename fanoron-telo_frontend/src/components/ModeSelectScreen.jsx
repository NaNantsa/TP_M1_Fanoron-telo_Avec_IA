...
const MODES = [
  ...
  },
  {
    id: "aivai",
    title: "IA vs IA",
    desc: "Deux IA jouent automatiquement",
    icon: IconRefresh,
    ai: true,
  },
];
...
export default function ModeSelectScreen({ onStart, onBack }) {
  ...
  // 🔥 NOUVEAU : difficulté séparée pour chaque IA
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-10 fade-in relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage:
          "linear-gradient(rgba(74,144,217,0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(74,144,217,0.035) 1px, transparent 1px)",
        backgroundSize: "52px 52px",
      }} />
          ...
          {MODES.map((m) => {
            ...
            return (
              <button
                ...
                onClick={() => setMode(m.id)}
                style={{
                  background: active ? "rgba(74,144,217,0.25)" : "rgba(15,30,51,0.7)",
                  border: active
